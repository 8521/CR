...
import com.ilaquidain.constructionreporterpro.dialogfragments.editphoto_dialogfragment;
import com.ilaquidain.constructionreporterpro.object.Image_Object;
            ...
            switch (v.getId()){
                ...
                case R.id.btn_viewphoto:
                    ...
                    Uri PhotoUri2 = FileProvider.getUriForFile(getActivity(),
                            "com.ilaquidain.constructionreporterpro.provider",f8);
