...
public class F_1_1_2_EditViewReports extends Fragment {
    ...
    private class viewholder_edit_reports extends RecyclerView.ViewHolder implements
        ...
        public viewholder_edit_reports(View itemView) {
            ...
            extededview = (LinearLayout)itemView.findViewById(R.id.extended_view);
            expanded_viewreport = (TextView)itemView.findViewById(R.id.expanded_viewreport);
            expanded_deletereport = (TextView)itemView.findViewById(R.id.expanded_deletereport);
            expanded_duplicatereport = (TextView)itemView.findViewById(R.id.expanded_duplicate);
