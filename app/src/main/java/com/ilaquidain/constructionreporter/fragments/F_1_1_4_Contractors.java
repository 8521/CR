...
public class F_1_1_4_Contractors extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        FloatingActionButton fab_add_contractor = v.findViewById(R.id.fab_addcontractor);
    ...
    private class viewholder_contractor extends RecyclerView.ViewHolder
        ...
        private viewholder_contractor(View itemView) {
            super(itemView);
            expanded_contractorview = itemView.findViewById(R.id.expanded_contractorview);
            txt_contractorname = itemView.findViewById(R.id.txt_contractor_name);
            txt_contractor_address = itemView.findViewById(R.id.txt_expanded_contractoraddress);
            txt_contractor_number = itemView.findViewById(R.id.txt_expanded_contractornumber);
            txt_contractor_edit = itemView.findViewById(R.id.txt_expanded_contractoredit);
            txt_contractor_delete = itemView.findViewById(R.id.txt_expanded_contractordelete);
