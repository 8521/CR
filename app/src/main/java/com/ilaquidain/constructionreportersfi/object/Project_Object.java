...
public class Project_Object implements Parcelable,Serializable, Cloneable {
    ...
    private ArrayList<ArrayList<Report_Object>> ProjectReports;
    ...
    public void setProjectContractNo(String s3){
        ProjectContractNo =s3;}
    public String getProjectContractNo(){return ProjectContractNo;}
    ...
    public ArrayList<ArrayList<Report_Object>> getProjectReports() {
        return ProjectReports;
    }

    public void setProjectReports(ArrayList<ArrayList<Report_Object>> projectReports) {
