...
public class f00202_QAeditreport extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.f0202_qareportedit,container,false);
                ...
                case R.id.expanded_duplicate:
                    ...
                    buider.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            try{
                                duplicated_report = currentproject.getProjectReports().get(reporttypenumber)
