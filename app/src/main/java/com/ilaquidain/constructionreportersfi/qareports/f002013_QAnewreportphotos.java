...
import com.ilaquidain.constructionreportersfi.dialogfragments.editphoto_dialogfragment;
...
public class f002013_QAnewreportphotos extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.f02013_qanewreportphotos,container,false);
        SetUpBitMapOptions();
        ...
        //currentreport = (qa_report_obj) getArguments().getSerializable("currentreport");
    ...
    private class photoadapter extends RecyclerView.Adapter<photoviewholder> implements HelperAdapter12{
        ...
        public photoviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.rvitem_02_photoitem,
                    parent,false);
