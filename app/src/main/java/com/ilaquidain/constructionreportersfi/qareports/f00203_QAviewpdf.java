...
public class f00203_QAviewpdf extends Fragment{
    ...
    private int mExpandedPosition = -1, reporttypenumber;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.f0203_qareportviewpdf,container,false);
        ...
        if(currentproject!=null){
            ...
            String s2 = getActivity().getResources().getStringArray(R.array.reporttypes)[reporttypenumber];;
            FolderPathFile = new File(Environment.getExternalStoragePublicDirectory(
                    Environment.DIRECTORY_DOCUMENTS)+File.separator+"ConstructionReporterSFI"
                    +File.separator+s1,s2);
            ObtainProjectPDFS();
        }
