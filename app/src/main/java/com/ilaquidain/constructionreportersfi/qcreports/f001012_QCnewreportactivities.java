...
public class f001012_QCnewreportactivities extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.f01012_qcnewreportactivities,container,false);
        ...
        FloatingActionButton fab = v.findViewById(R.id.fab_addactivity);
        fab.setOnClickListener(this);
        FloatingActionButton fabaccept = v.findViewById(R.id.fab_accept);
    ...
    private class adapter_7 extends RecyclerView.Adapter<viewholder_7> implements Interface_Adapter_7 {
        ...
        public viewholder_7 onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.rvitem_09_qcreport_activity,
                    parent,false);
        ...
        public void onBindViewHolder(viewholder_7 holder, int position) {
            holder.textView.setText(selectedtasks.get(position).getAct_No());
        }
    ...
    private class viewholder_7 extends RecyclerView.ViewHolder implements Interface_ViewHolder_7,View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            f001012_z2_qcnewreportactitvitiesedit_df edittask = new f001012_z2_qcnewreportactitvitiesedit_df();
    ...
    //Exit Method - Depicted
    /*private void ExitMethod() {
        currentreport.setQcreport_selectedactivities(selectedtasks);
        if(reportnumber==-1){
            savedinfo.setTempqcreport(currentreport);
        }else {
            savedinfo.getSavedProjects().get(projectnumber).getqc_reports().set(reportnumber,currentreport);
        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.fab_addactivity:
                EditTaskDialogFragment();
                break;
            case R.id.fab_accept:
                if ( getFragmentManager().getBackStackEntryCount() > 0)
                {getFragmentManager().popBackStack();}
                else {
                    FragmentManager fm = getFragmentManager();
                    Fragment fgmt = new f00101_QCnewreport();
                    fm.beginTransaction()
    ...
    private void EditTaskDialogFragment() {
        ...
        mprefedit= mpref.edit();
        mprefedit.putInt("tasknumber",-1);
        mprefedit.apply();

        f001012_z2_qcnewreportactitvitiesedit_df dialog_choose = new f001012_z2_qcnewreportactitvitiesedit_df();
