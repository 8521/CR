...
public class f00103_QCviewpdf extends Fragment{
    ...
    private Integer projectnumber,reporttypenumber;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.f0103_qcreportviewpdf,container,false);
        ...
        if(currentproject!=null){
            ...
            FolderPathFile = new File(Environment.getExternalStoragePublicDirectory(
                    Environment.DIRECTORY_DOCUMENTS)+File.separator+"ConstructionReporterSFI"+File.separator+s1,
                    s2);
            ObtainProjectPDFS();
        }
