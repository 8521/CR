...
public class chooseactivity_dialogfragment extends DialogFragment implements View.OnClickListener {
    ...
    private void ExitMethod() {
        ...
        if(reportnumber==-1){
            ...
            savedinfo.getSavedProjects().get(projectnumber).getProjectReports().get(reporttypenumber).set(reportnumber,currentreport);
        }
